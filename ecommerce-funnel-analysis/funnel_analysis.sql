SELECT  * FROM `ecom-funnel.ecommerce_data.ecommerce_data` LIMIT 1000
...
WITH funnel_stages AS (
  ...
  FROM `ecom-funnel.ecommerce_data.ecommerce_data`
...
SELECT
  ...
  ROUND(AVG(TIMESTAMP_DIFF(purchase_time, cart_time, MINUTE)),2) AS avg_cart_to_purchse_minutes,
...
SELECT
  ...
  total_revenue/ total_buyers AS avg_revenue_per_buyer,
  total_revenue/ total_visitors AS avg_revenue_per_visitor,
